...
public class AddressNumberActivity extends AppCompatActivity {
...
//            @Override
//            public void onClick(View v) {
//                startActivity(new Intent(AddressNumberActivity.this,ShipmentDetailActivity.class));
//            }
//        });
//    }
//
...
//                        Toast.makeText(AddressNumberActivity.this, apiError.getMessage(), Toast.LENGTH_SHORT).show();
//                    } catch (IOException e) {
//                        e.printStackTrace();
//                    }
//                }
...
//                Toast.makeText(AddressNumberActivity.this, "Lỗi server", Toast.LENGTH_SHORT).show();
//            }
//        });
//
//    }
