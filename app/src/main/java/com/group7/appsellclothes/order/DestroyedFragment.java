...
import com.group7.appsellclothes.adapter.OrderDestroyedAdapter;
...
public class DestroyedFragment extends Fragment {


    RecyclerView recOrder;
    OrderDestroyedAdapter orderDestroyedAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_destroyed, container, false);
        ...
        ApiService.apiService.getMyOrder(accept, accessToken,"").enqueue(new Callback<ListOrderResponse>() {
            ...
            public void onResponse(Call<ListOrderResponse> call, Response<ListOrderResponse> response) {
                if(response.isSuccessful()){
                    ...
                    orderDestroyedAdapter= new OrderDestroyedAdapter(getActivity(),listOrder);
                    recOrder.setAdapter(orderDestroyedAdapter);
                    orderDestroyedAdapter.notifyDataSetChanged();
                }else {
